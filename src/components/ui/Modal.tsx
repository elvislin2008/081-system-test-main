...
export default function Modal({ open, onClose, title, children, size = 'md' }: ModalProps) {
  ...
  return (
    ...
    >
      <div className={`bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full ${sizeClasses[size]} max-h-[90vh] flex flex-col animate-slide-up border border-slate-200/50 dark:border-slate-700/50`}>
        {title && (
